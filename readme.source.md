...
(function() {
 ...
 var categories = [
   ...
   { title: 'AI & ML', color: '#38bdf8', items: ['PyTorch', 'TensorFlow', 'OpenCV', 'Scikit-Learn'] },
   { title: 'Frameworks', color: '#f43f5e', items: ['React', 'Next.js', 'FastAPI', 'Node.js'] },
 ];
 ...
 return (
   <div style={{
     ...
     <svg width="860" height="210" style={{ position: 'absolute', top: 0, left: 0 }}>
       ...
       <ellipse id="glow-1" cx="170" cy="210" rx="260" ry="170" fill="url(#g1)" />
       <ellipse id="glow-2" cx="320" cy="220" rx="220" ry="140" fill="url(#g2)" />
       <ellipse id="glow-3" cx="460" cy="220" rx="190" ry="130" fill="url(#g3)" />
       <ellipse id="glow-4" cx="590" cy="230" rx="160" ry="110" fill="url(#g4)" />
       <ellipse id="glow-5" cx="750" cy="230" rx="140" ry="100" fill="url(#g5)" />
       ...
       {categories.map(function(cat) {
         return (
           <div key={cat.title} style={{ display:'flex', alignItems:'center', gap:16 }}>
             <div style={{ display:'flex', fontSize:10, fontWeight:700, color:cat.color, letterSpacing:'1px', width:90 }}>
